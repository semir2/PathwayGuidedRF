...
We finally simulate 30 individuals, of which 15 should be cases. The parameter 
gamma.range defines the the range of absolute effect sizes for the differential
expression.
...
For reduced run time we use only a small number of permutations for the 
prediction error method. However, the default value of 1000 should be used for
a real analysis.
